...
function LevelMaker.createMap(level)
    ...
    -- tracks whether the locked brick is added
    local IsLockedBrickAdded = false
    ...
    for y = 1, numRows do
	    ...
	    -- locking the brick using a random probability
	    if (not IsLockedBrickAdded) and math.random(1, 100) <= 20 then
		b.locked = true
		IsLockedBrickAdded = true
	    end

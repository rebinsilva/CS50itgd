...
function love.load()
    ...
    -- denotes whether the player is ai
    isPlayer1AI = false
    isPlayer2AI = false
...
function love.keypressed(key)
    ...
    elseif key == '1' then
	isPlayer1AI = not isPlayer1AI
    elseif key == '2' then
	isPlayer2AI = not isPlayer2AI
...
function love.draw()
    ...
    if gameState == 'start' then
        ...
        love.graphics.printf('Press 1 to toggle Player 1 AI', 0, 200, VIRTUAL_WIDTH, 'center')
        love.graphics.printf('Press 2 to toggle Player 2 AI', 0, 210, VIRTUAL_WIDTH, 'center')
    elseif gameState == 'serve' then
        -- UI messages
        love.graphics.setFont(smallFont)

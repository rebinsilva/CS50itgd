...
gTextures = {
    ...
    ['lock_and_keys'] = love.graphics.newImage('graphics/keys_and_locks.png'),
    ['flagposts'] = love.graphics.newImage('graphics/flags.png'),
    ['flagsets'] = love.graphics.newImage('graphics/flags.png'),
}
...
gFrames = {
    ...
    ['lock_and_keys'] = GenerateQuads(gTextures['lock_and_keys'], 16, 16),
    ['flagposts'] = GenerateFlagPosts(gTextures['flagposts']),
    ['flagsets'] = GenerateFlagSets(gTextures['flagsets'])
}
